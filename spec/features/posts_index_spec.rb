...
RSpec.describe 'posts index', type: :system do
  ...
  let!(:post1) do
    Post.create(user: user1, title: 'Post 1', text: 'Post 1 content', comments_counter: 1, likes_counter: 0)
  end
  let!(:post2) do
    Post.create(user: user1, title: 'Post 2', text: 'Post 2 content', comments_counter: 1, likes_counter: 0)
  end
